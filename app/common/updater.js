...
autoUpdater.on('checking-for-update', () => {
  ...
  // 禁止 --inspect-brk 除錯 以及 --remote-debugging-port
  //>>UNPACK_ANN]if(process.argv.find(o => ~o.indexOf('inspect') || ~o.indexOf('remote-debug'))) closeApp();
  
  // 禁止解包
  //>>UNPACK_ANN]if((!~__filename.indexOf('app.asar'))) closeApp();